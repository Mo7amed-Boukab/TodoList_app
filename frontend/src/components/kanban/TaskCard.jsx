...
const TaskCard = ({ task, onUpdate, onDelete, isMenuOpen, onToggleMenu, onClick, isOverlay }) => {
    const {
        attributes,
        listeners,
        setNodeRef,
    ...
    return (
        <div ref={setNodeRef} style={style} {...attributes} {...listeners}>
            <Card
                ...
                className={`flex flex-col gap-4 hover:shadow-lg hover:shadow-gray-200 transition-shadow cursor-pointer group relative ${isOverlay ? 'shadow-2xl ring-2 ring-black/5 bg-white' : ''}`}
            >
